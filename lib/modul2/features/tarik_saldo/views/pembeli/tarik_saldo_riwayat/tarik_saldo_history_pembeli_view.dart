...
class TarikSaldoHistoryPembeliView extends StatefulWidget {
  const TarikSaldoHistoryPembeliView({super.key});

  @override
  TarikSaldoHistoryPembeliViewState createState() =>
      TarikSaldoHistoryPembeliViewState();
}

class TarikSaldoHistoryPembeliViewState
    extends State<TarikSaldoHistoryPembeliView> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<WithdrawalPembeliProvider>(context, listen: false)
          .fetchWithdrawalsForCurrentUser(); // Ambil penarikan untuk pengguna
    });
  }

  // Fungsi untuk refresh data saat swipe down
  Future<void> _refreshData() async {
    await Provider.of<WithdrawalPembeliProvider>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Consumer<WithdrawalPembeliProvider>(
  ...
  // Fungsi untuk membuat kartu penarikan
  Widget _buildWithdrawalCard(TarikSaldoModel withdrawal) {
    return GestureDetector(
      onTap: () {
        // Navigasi ke halaman detail penarikan
        Navigator.push(
          context,
          MaterialPageRoute(
  ...
  // Fungsi untuk menampilkan badge status penarikan
  ...
  // Fungsi untuk mendapatkan warna ikon berdasarkan status
  ...
  // Fungsi untuk mendapatkan ikon status penarikan
  ...
  // Fungsi untuk mendapatkan ikon provider
  ...
  // Fungsi untuk mengelompokkan penarikan berdasarkan bulan
